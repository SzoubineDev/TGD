...
const ALL_TRANSLATIONS = {
  ...
  team: {
    ...
    ar: {
      ...
      'english-chief-role': 'رئيس قسم الإنجليزية',
      'english-chief-desc':
      ...
      'arabic-chief-role': 'رئيس قسم العربية',
      'arabic-chief-desc':
      ...
      'french-chief-role': 'رئيس قسم الفرنسية',
      'french-chief-desc':
        'طالب اقتصاد  يجيد الفرنسية بطلاقة. ينظم جلسات المناظرة باللغة الفرنسية ويساعد الأعضاء على إتقان دقائق الجدال باللغة الفرنسية.',
